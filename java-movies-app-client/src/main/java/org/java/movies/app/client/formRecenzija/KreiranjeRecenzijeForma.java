...
import org.java.movies.app.client.formFilm.*;

/**
 *
 * @author Administrator
 */
public class KreiranjeRecenzijeForma extends javax.swing.JDialog {

    /**
     * Creates new form KreirajRecenzijuForma
     */
    public KreiranjeRecenzijeForma(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        prepareView();
    ...
    private void initComponents() {
        ...
        btnKreirajRecenziju = new javax.swing.JButton();
        ...
        btnKreirajRecenziju.setText("Kreiraj recenziju");
        btnKreirajRecenziju.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnKreirajRecenzijuActionPerformed(evt);
            }
        });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(503, 625, Short.MAX_VALUE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(btnKreirajRecenziju, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(16, 16, 16))))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(btnKreirajRecenziju, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void btnKreirajRecenzijuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKreirajRecenzijuActionPerformed
        ...
        try {
            ...
            Date datum = new Date();
            MainForma m = (MainForma) getParent();

            Recenzija recenzija = new Recenzija(-1l, datum, ocena, tekst, null, film);
           Communication.getInstance().saveRecenzija(recenzija);
            JOptionPane.showMessageDialog(this, "Uspešno sacuvana recenzija!", "Poruka", JOptionPane.INFORMATION_MESSAGE);
           this.dispose();
        } catch (Exception ex) {
             JOptionPane.showMessageDialog(this, "Sva polja moraju biti popunjena!", "Greska", JOptionPane.ERROR_MESSAGE);
        }
    }//GEN-LAST:event_btnKreirajRecenzijuActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KreiranjeRecenzijeForma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                KreiranjeRecenzijeForma dialog = new KreiranjeRecenzijeForma(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JButton btnKreirajRecenziju;
    ...
    private void prepareView() {
        try {
            ...
            txtUtisak.setLineWrap(true);
            txtUtisak.setWrapStyleWord(true);
        } catch (Exception ex) {
            Logger.getLogger(KreiranjeRecenzijeForma.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
